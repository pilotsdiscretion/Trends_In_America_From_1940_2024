...
- **Firearms** — household gun ownership over time, total civilian firearms and per-capita rate, firearms by type, concealed-carry permits and the spread of permitless ("constitutional") carry, major Second Amendment Supreme Court cases, and the (heavily contested) data on lawful defensive gun use and home defense. It also covers the most- versus least-armed states over time (RAND household-ownership estimates, all firearm types — Montana/Wyoming/Alaska highest, Massachusetts/Hawaii/New Jersey lowest), major manufacturers (leaders, production trends, bankruptcies/consolidations), caliber trends, the most popular handgun/rifle/shotgun and their calibers by era, law-enforcement caliber adoption, industry-liability lawsuits, and ATF crime-gun trace data (most-traced makes and calibers).
- **Pharmaceuticals** — prescription spending, the opioid waves and DTC advertising; FDA approvals/recalls and drug-development cost; the most-prescribed drugs over time (1940s penicillin → 1970s Valium → today's generics), a 2010-vs-2023 top-10 comparison and a leading-drugs-over-time trend, drug-price trends (insulin, EpiPen, Humira), and non-prescription (OTC) medicine sales, categories and the major Rx-to-OTC switches.
- **Entertainment** — TV penetration, viewing hours, movie admissions, streaming vs. cable, social media, screen time and ad spend; plus the biggest film and #1 Nielsen TV show every year (1940–2026), the biggest film's worldwide gross over time, the collapse of the #1 show's rating as audiences fragmented, and how movie/TV genres shifted (war films → epics → musicals → blockbusters → franchises/superhero/animation).
...
- **Healthcare** — national health spending and the cost of coverage, plus the uninsured rate over time (16% in 2010 → ~7.7% in 2023 after the ACA), where Americans get coverage (employer, Medicaid, Medicare, marketplace), and how U.S. per-capita spending compares with peer nations (roughly double the wealthy-country average).
- **Religion** — affiliation since the 1940s and the rise of the "nones," plus church membership and weekly attendance, belief in God and the importance of religion, and the unaffiliated share by generation (Silent → Gen Z).
- **Mental Health** — diagnoses, antidepressant use and deinstitutionalization, plus the U.S. suicide rate over time and the post-2012 surge in adolescent distress (steepest among girls).
- **Family & population health depth** — births to unmarried mothers and the record-low teen birth rate (Sex & Partners); children's living arrangements (Marriage & Family); the safety net's effect on poverty by age (Poverty); childhood obesity by age group (Obesity); and vaccine-preventable-disease eradication alongside rising kindergarten exemptions (Vaccines).
